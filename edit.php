...
$error = ['msg' => ''];
$fullname = $dob = $mob = $yob = $phone_number = $id = "";

if (isset($_GET['edit'])) {
  $id = $_GET['edit'];
  $edit = "SELECT * FROM celebrants WHERE id=$id";
...
if (isset($_POST['update'])) {
  ...
  if (!array_filter($error)) {
    ...
    $update = "UPDATE celebrants SET fullname = '$fullname',dob = '$dob',mob = '$mob',yob = '$yob', phone_number = '$phone_number' WHERE id = '$id'";
...
<body>
  ...
  <div class="container">
    ...
    <form action="" class="form" method="POST">
      ...
      <input type="submit" class="input-button" value="Update Details" name="update">
    </div>
  </form>
</div>
